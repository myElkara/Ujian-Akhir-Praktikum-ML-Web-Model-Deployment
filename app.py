...
def predict():
    ...
    if preprocessing_number == 0: 
        ...
        # Dapatkan probabilitas prediksi untuk kelas tersebut
    ...
    prediction_probability_percent = round(prediction_probability * 100, 2)

    return render_template('predict.html', filename=filename, prediction=predicted_class, prediction_probability=prediction_probability_percent, prediction_time=prediction_time)
